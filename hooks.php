 ...
 * 
 * @package KsfFA_ksf_FA_Recruitment
 * @version 2.4.3
 */

define('SS_ksf_FA_Recruitment', 132 << 8);
...
class hooks_ksf_FA_Recruitment extends hooks {
    ...
    function install_tabs($app) {
        ...
        // return new ksf_FA_Recruitment_app();
    }
    ...
    function install_access() {
        $security_sections[SS_ksf_FA_Recruitment] = _("");
        $security_areas['SA_ksf_FA_RecruitmentVIEW'] = array(
            SS_ksf_FA_Recruitment | 1, 
            _("View ")
        );
        $security_areas['SA_ksf_FA_RecruitmentMANAGE'] = array(
            SS_ksf_FA_Recruitment | 2, 
            _("Manage ")
        );
